...
This release packages 12 recent commits focused on documentation, themes, and platform.
...
### Browser-first workspace upgrade

The app now centers the browser runtime with tighter template tooling, local draft workflows, and clearer in-app boundaries around browser-only storage.
