...
export const roadmapGroups: RoadmapGroup[] = [
  ...
  },
  {
    ...
    placeholderFiles: [
      'packages/web/src/components/drafts/DraftComparisonPlaceholder.tsx',
      'packages/web/src/components/drafts/ReviewChecklistPlaceholder.tsx',
      'packages/web/src/components/drafts/VersionHistoryPlaceholder.tsx',
    ],
    items: [
  ...
  },
  {
    ...
    placeholderFiles: [
      ...
      'packages/web/src/components/templates/TemplateComparisonPlaceholder.tsx',
      'packages/web/src/components/blueprints/BlueprintLintPlaceholder.tsx',
      'packages/web/src/components/blueprints/BlueprintSandboxPlaceholder.tsx',
    ],
    items: [
